	...
	@foreach($photo_categories as $photo_category)
		<tr>
			...
			<td>
				...
				<a class="btn btn-small btn-success" href="{{ URL::to('admin/photo_categories/' . $photo_category->id) }}">Show this Photo category</a>

				<!-- edit this photo (uses the edit method found at GET /photos/{id}/edit -->
				<a class="btn btn-small btn-info" href="{{ URL::to('admin/photo_categories/' . $photo_category->id . '/edit') }}">Edit this Photo category</a>

				<!-- delete the photo (uses the destroy method DESTROY /photos/{id} -->
				<!-- we will add this later since its a little more complicated than the other two buttons -->
				{{ Form::open(array('url' => 'admin/photo_categories/' . $photo_category->id, 'class' => 'pull-right')) }}
